...
if ($_FILES["upload_file"]["error"] > 0) {
  ...
  if (file_exists("upload/" . $_FILES["upload_file"]["name"])) {
    ...
    // If file size less than 150k, display base64 content.
    $filename = "upload/" . $_FILES["upload_file"]["name"];
    if ($_FILES["upload_file"]["size"] / 1024 < 150) {
...
?>
<br><br><br>
<a href="upload.php" style="text-decoration:none;color:#29c">Continue Upload</a>
